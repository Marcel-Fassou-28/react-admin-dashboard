...
{ id: 1, name: "John Doe", email: "john@example.com", role: "Customer", status: "Active" },
  ...
  { id: 3, name: "Michael Brown", email: "michael@example.com", role: "Customer", status: "Active" },
  { id: 4, name: "Emily Davis", email: "emily@example.com", role: "Moderator", status: "Active" },
  { id: 5, name: "Chris Johnson", email: "chris@example.com", role: "Customer", status: "Active" },
  { id: 6, name: "Laura Wilson", email: "laura@example.com", role: "Admin", status: "Active" },
  { id: 7, name: "Daniel Lee", email: "daniel@example.com", role: "Customer", status: "Inactive" },
  { id: 8, name: "Sarah Kim", email: "sarah@example.com", role: "Moderator", status: "Active" }
]
                            ...
                            transition={{duration: 0.3}}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                                        user.status === "Active" ? "bg-green-800 text-gray-100" : "bg-red-800 text-red-100"
                                    }`}>
                                        {user.status}
                                    </span>
                                </td>
